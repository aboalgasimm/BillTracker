...
function initTables(db: Database.Database) {
  ...
  // Rent Payments Table (June & December)
  db.exec(`
  ...
  // Maintenance & Service History Table
  db.exec(`
  ...
  // Seed Water Rotation Table if empty
  ...
  // Seed Rent Payments (June & December)
  ...
  // Update any existing seeded bills / maintenance to "عربية" if already created
  db.exec(`
